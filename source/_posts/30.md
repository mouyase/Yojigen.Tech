...
## 最终预期的结果
在尽可能保证正常网络没有不会受到影响的情况下，实现网内透明代理，以用于科学上网。
附赠功能: 去广告，虚拟局域网组网等
## 设备选择和采购
...
[paopao-gateway-x86-64-custom-d866b29.7z](https://github.com/mouyase/PaoPaoGateWay/releases/download/20240415-0cee8a4/paopao-gateway-x86-64-0cee8a4.7z)
